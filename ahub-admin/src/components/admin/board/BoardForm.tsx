...
import { useUploadBoardMemberImage } from "@/hooks/useCMS";
...
export function BoardForm({ initialData, onSubmit, onCancel, isSubmitting }: BoardFormProps) {
  const uploadImageMutation = useUploadBoardMemberImage();
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          <Input
            id="title"
            required
            placeholder="Director / Founder / Advisor"
            value={title}
